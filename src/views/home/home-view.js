          ...
          <div class="technologies">
            <div class="tech-card" aria-label="HTML5" tabindex="0">
              ...
              <p class="card-text" tabindex="0">
                HTML5 is a software solution stack that defines the properties and behaviors of <b class="card-decorator">web page 
                content</b> by implementing a markup-based pattern to it
              </p>
            ...
            <div class="tech-card" aria-label="CSS3" tabindex="0">
              ${css3_svg}
              <p class="card-text" tabindex="0">
                Cascading Style Sheets (CSS) is a style sheet language used for describing the <b class="card-decorator">presentation</b> 
            ...
            <div class="tech-card" aria-label="Javascript" tabindex="0">
              ${js_svg}
              <p class="card-text" tabindex="0">
                JavaScript is a programming language that conforms to 
                the <b class="card-decorator">ECMAScript specification</b>. JavaScript is high-level, often just-in-time compiled, 
                and multi-paradigm
              </p>
        ...
        <section aria-label="About dsign project" tabindex="0">
          <div class="information">
            ...
            <p class="info-text" tabindex="0">
                This project includes a <b>responsive web layout</b> following best practices about presentation,
                layout and accessibility using HTML5 and CSS3. <br><br> A basic example about how a simple web layout
                can be developed from the skeleton to the style, respecting the most important aspects about user
                experience and accesibility such as <b>tab navigation, color contrast ratio, text readability, content distribution</b> and also
                non-visual aspects like <b>semantic elements, attributes, clean code</b> in order to build  a more diverse and powerful
        ...
        <section aria-label="Web design disciplines" tabindex="0">
          <div class="areas">
            ...
            <article class="area-card center">
              ...
              <p class="info-text" tabindex="0">Web accessibility is the inclusive practice of <b>ensuring there are no barriers</b> that prevent interaction with, 
                or access to, websites on the World Wide Web <b>by people with physical disabilities, situational disabilities, and socio-economic 
                restrictions on bandwidth and speed.</b> <br><br>When sites are correctly designed, developed and edited, generally all users have equal 
                access to information and functionality.</p>
            </article>
            <article class="area-card">
              <h2 class="area-title" tabindex="0">User interface</h2>
              <p class="info-text" tabindex="0">The user interface (UI), in the industrial design field of human-computer interaction, is the <b>space where 
                interactions between humans and machines occur.</b> <br><br>The goal of this interaction is to allow effective operation and control of 
